                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">BRANDS<i class="fa fa-angle-down float-right mt-1"></i></
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">vvisheshanghvivishesahnghviiiivivivi
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    ...
                    <a class="text-dark font-weight-semi-bold" href="https://instagram.com/visheshsanghvi__?igshid=YmMyMTA2M2Y=">VISHESH SANGHVI</a>
